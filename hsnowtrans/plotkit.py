...
def plot_undirected_unweighted_without_y(
    ...
    # 4. Add nodes and edges to the graph -- unweighted version
    ...
    # 6. Perform graph layout using sfdf_layout and draw the graph using graph_draw
...
def plot_undirected_weighted_without_y(
    ...
    # 4. Add edges and set edge weights -- weighted version 
